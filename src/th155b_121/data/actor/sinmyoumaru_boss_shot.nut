...
function Boss_Shot_MS1( t )
{
	...
	this.subState = function ()
	{
		if (this.C_Vec_BrakeLimited(this.va, 0.50000000, 0.50000000))
		{
			this.subState = function ()
			{
			};
...
function Boss_Shot_MS1B( t )
{
	...
	this.subState = function ()
	{
		if (this.C_Vec_BrakeLimited(this.va, 0.20000000, 0.50000000))
		{
			this.subState = function ()
			{
			};
...
function Shot_S3_LaserBullet( t )
{
	...
	{
		this.count++;
		this.C_SetSpeed_XY(this.va, this.va.x * 0.94999999, this.va.y * 0.94999999);
