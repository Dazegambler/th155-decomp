...
function Slave_Attack_Doremy( t )
{
	...
	{
		this.Vec_Brake(1,00000000.0, 0,25000000.0);
	};
	this.func = [
		function ()
		{
...
function Master_Spell_D2_Start()
{
	...
	this.stateLabel = function ()
	{
		if (this.count <= 10)
		{
			this.AddSpeed_XY(-0,50000000.0 * this.direction, -0,15000001.0);
		}
...
function Master_Spell_D2_Move()
{
	...
	this.flag1.y = this.y < this.centerY ? 0,10000000.0 : -0,10000000.0;
	this.stateLabel = function ()
	{
		if (this.count <= 15)
		{
...
function Master_Spell_D2_Attack_B( t )
{
	...
	this.stateLabel = function ()
	{
		...
		if (this.direction == 1,00000000.0 && this.x > 900 || this.direction == -1,00000000.0 && this.x < 340)
		{
			this.SetMotion(4995, 3);
			this.stateLabel = function ()
			{
				this.Vec_Brake(0,33000001.0);
...
function DS3_Start()
{
	...
	this.stateLabel = function ()
	{
		...
		this.SetSpeed_XY((640 - this.x) * 0,10000000.0, (this.centerY - 100 - this.y) * 0,10000000.0);
	...
	this.subState = function ()
	{
		...
		if (this.count == 90)
		{
			...
			this.subState = function ()
			{
				...
				{
					this.AddSpeed_XY(0,00000000.0, -0,25000000.0, 0,00000000.0, -0,75000000.0);
				}
...
function DS3_Attack_A( t )
{
	...
	this.subState = function ()
	{
		...
		local r_ = (this.y - 360) / 360,00000000.0;
		this.SetSpeed_XY(4,00000000.0 * r_ * this.direction, this.va.y);
...
function DS3_Attack_B( t )
{
	...
	this.subState = function ()
	{
		::camera.Shake(3,00000000.0);
		local r_ = (this.y - 360) / 360,00000000.0;
		this.SetSpeed_XY(-5,00000000.0 * r_ * this.direction, this.va.y);
...
function DS3_Attack_C( t )
{
	...
	this.freeMap = true;
	::camera.Shake(6,00000000.0);
	::camera.auto_zoom_limit = 1,25000000.0;
	::camera.lock = true;
	this.lavelClearEvent = function ()
	{
		if (this.flag4)
	...
	this.subState = function ()
	{
		...
		{
			if (this.VY_Brake(0,50000000.0) && this.count >= 90)
			{
				...
				this.subState = function ()
				{
					...
					if (this.flag2 >= 1,50000000.0)
					{
						this.flag2 = 1,50000000.0;
					}

					this.flag1.RotateByDegree(this.flag2 * this.direction);
					this.Warp(this.flag3.x + this.flag1.x, this.flag3.y + this.flag1.y * 0,50000000.0);
					this.flag5.slave.Warp(this.flag3.x - this.flag1.x, this.flag3.y - this.flag1.y * 0,50000000.0);

					if (this.flag5.spark)
					{
						this.flag5.spark.rz += this.flag2 * 0,01745329.0;
						this.flag5.spark.Warp(this.x + this.flag1.x * 0,75000000.0, this.y + this.flag1.y * 0,75000000.0);
						this.flag5.spark.SetCollisionRotation(0,00000000.0, 0,00000000.0, this.flag5.spark.rz);
					}

					if (this.flag5.slave && this.flag5.slave.flag5)
					{
						this.flag5.slave.flag5.rz -= this.flag2 * 0,01745329.0;
						this.flag5.slave.flag5.Warp(this.x - this.flag1.x * 0,75000000.0, this.y - this.flag1.y * 0,75000000.0);
						this.flag5.slave.flag5.SetCollisionRotation(0,00000000.0, 0,00000000.0, this.flag5.slave.flag5.rz);
					}
					...
					if (this.count >= 360)
					{
						...
						this.subState = function ()
						{
							...
							if (this.count == 30)
							{
								...
								this.subState = function ()
								{
									this.AddSpeed_XY(0,00000000.0, -0,50000000.0, 0,00000000.0, -15,00000000.0);
...
function Master_Spell_D4_Start()
{
	...
	this.keyAction = [
		...
		function ()
		{
			...
			this.stateLabel = function ()
			{
				this.SetSpeed_XY((640 - this.x) * 0,20000000.0, (300 - this.y) * 0,20000000.0);
