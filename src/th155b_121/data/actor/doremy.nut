...
function Team_Change_AirMoveB( t_ )
{
	...
	this.flag5.vx = 5,00000000.0;
	this.flag5.vy = 5,50000000.0;
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				else if (this.va.x != 0,00000000.0)
				{
		...
		this.keyAction = [
			function ()
			{
				...
				this.stateLabel = function ()
				{
					...
					this.AddSpeed_XY(0,50000000.0 * this.direction, -1,00000000.0, 6,00000000.0 * this.direction, -7,50000000.0);

					if (this.y < this.centerY - 150 && this.va.y <= -4,50000000.0 || !this.flag1 && this.keyTake == 2 || this.y < this.centerY - 25 && this.count >= 20)
					{
						this.hitResult = 1;
		...
		this.keyAction = [
			function ()
			{
				...
				this.stateLabel = function ()
				{
					...
					this.AddSpeed_XY(1,00000000.0 * this.direction, 0,25000000.0, 6,00000000.0 * this.direction, 6,00000000.0);
			...
			this.stateLabel = function ()
			{
				...
				if (this.input.x == 0)
				{
					...
					else
					{
						...
						this.SetSpeed_Vec(3,00000000.0, r_);
					}
				}
				else
				{
				...
				if (this.va.y < 0,00000000.0 && this.y < ::battle.scroll_top + 128)
				{
				...
				{
					local t_ = {};
					t_.rot <- this.flag2 * 0,01745329.0;
					t_.v <- 12,50000000.0;
