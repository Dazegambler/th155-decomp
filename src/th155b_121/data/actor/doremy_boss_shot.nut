...
function Boss_Shot_MS1_B( t )
{
	...
	{
		this.SetCollisionScaling(this.sx, this.sy, 1.00000000);
		this.C_AddFreeSpeed_XY(this.va, 0.00000000, 0.50000000);
		this.count++;
		...
		if (this.count >= 24)
		{
			...
			this.C_AddFreeSpeed_XY(this.va, 0.00000000, -6.00000000);
			this.count = 0;
		}
	};
	this.func = [
			...
			this.stateLabel = function ()
			{
				...
				if (this.count == 45)
				{
					this.stateLabel = function ()
					{
						...
						this.C_AddSpeed_XY(this.va, 0.00000000, -0.25000000, null, -20.00000000);
...
function Boss_Shot_MS1_Fall( t )
{
	...
	this.stateLabel = function ()
	{
		...
		this.C_AddSpeed_XY(this.va, 0.00000000, 0.15000001, 0.00000000, 10.00000000);
	};
}
