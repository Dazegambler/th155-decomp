	...
	else
	{
		...
		if (this.centerStop * this.centerStop <= 1)
		{
			...
			if (d_ <= 125)
			{
				...
				{
					if (this.com_rand[3] <= 33)
					{
						this.CPU_AtkUnder(-120);
						return;
					}

					if (this.com_rand[3] <= 43 && h_ <= 100)
					{
						this.CPU_SkillE(-60);
						return;
					}
				...
				]))
				{
					...
					if (this.com_rand[3] <= 76 && h_ <= 100)
					{
						this.CPU_SkillE(-60);
						return;
					}

					this.CPU_AtkStop(-15 - this.rand() % 15);
					return;
				}
			...
			if (d_ <= 250)
			{
				...
				]))
				{
					...
					if (this.com_rand[3] <= 66)
					{
						if (d_ <= 180 && this.com_enemyPos <= 19)
						{
							this.CPU_AtkUpper(-60);
							return;
						}
			...
			]))
			{
				...
				if (this.com_rand[3] <= 76)
				{
					this.CPU_ShotCharge(-60);
					return;
				}

				if (this.com_rand[3] <= 86)
				{
					this.CPU_SkillB(-60);
					return;
				}

				this.CPU_AtkStop(-30 - this.rand() % 31);
				return;
			}
		}
		else
		{
			if (d_ <= 250)
			{
				...
				{
					if (this.target.y < this.y && this.va.y < 0 || this.target.y > this.y && this.va.y > 0)
					{
						this.CPU_AtkMid(-50);
						return;
					}
					...
					{
						if (this.com_enemyPos == 2)
						{
							this.CPU_AtkUnder(-60);
							return;
						}

						if (this.com_enemyPos == 5)
						{
							this.CPU_AtkMid(-60);
							return;
						}

						if (this.com_enemyPos == 8)
						{
							this.CPU_AtkUpper(-60);
							return;
						}
...
function CPU_AtkFool( wait_ )
{
	...
	{
		if (this.motion >= 40 && this.motion <= 43 && this.com_count[3] <= -20 && this.centerStop == 0)
		{
			this.com_count[3] = -19;
		}
			...
			this.com_subState[3] = function ()
			{
				...
				if (this.motion >= 3030 && this.motion <= 3039)
				{
					...
					this.com_subState[3] = function ()
					{
						...
						if (this.centerStop == 0 && this.com_count[3] <= -60)
						{
							this.command.rsv_k2 = 1;
							this.command.rsv_x = 0;
							this.command.rsv_y = -1;
...
function CPU_AtkMid( wait_ )
{
	...
	if (this.centerStop * this.centerStop <= 1)
	{
		if (this.abs(this.targetDist) <= 250)
		{
			this.com_subState[3] = function ()
			{
				if (this.com_count[3] > 0 || this.centerStop * this.centerStop >= 4)
				...
				if (this.motion == 1100 || this.motion == 1000)
				{
					if (this.keyTake == 2)
					{
						if (this.team.spell_active && this.spellcard.id == 2 && this.hitResult & 1)
						{
							this.CPU_SkillC(-60);
							return;
						}
		...
		else
		{
			this.com_subState[3] = function ()
			{
				...
				if (this.motion == 40)
				{
					if (this.keyTake <= 2 && this.abs(this.targetDist) <= 175)
					{
						this.command.rsv_k0 = 1;
						this.command.rsv_x = 0;
					}
		...
		if (this.motion == 1220 || this.motion == 1221 || this.motion == 1222)
		{
			if (this.keyTake == 2)
			{
				this.com_subState[3] = function ()
				{
					...
					if (this.team.spell_active && this.spellcard.id == 1 && this.hitResult & 1)
					{
						this.CPU_SpellB(-60);
						return;
					}
...
function CPU_AtkUnder( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		{
			if (this.keyTake >= 3 && this.y > this.centerY + 150)
			{
				if (this.team.spell_active && this.spellcard.id == 0 && this.hitResult & 1)
				{
					this.CPU_SpellA(-60);
					return;
				}
...
function CPU_AtkFront( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		{
			if (this.keyTake >= 2 && this.hitResult || this.keyTake >= 3)
			{
				if (this.hitResult & 1 && this.com_rand[3] <= 5)
				{
					this.CPU_SkillD(-60);
					return;
				}
...
function CPU_AtkDashLow( wait_ )
{
	...
	if (this.centerStop * this.centerStop <= 1)
	{
		this.com_subState[3] = function ()
		{
			...
			else if (this.motion == 1300 && this.hitResult)
			{
				if (this.team.spell_active && this.spellcard.id == 2 && this.hitResult & 1)
				{
					this.CPU_SkillC(-60);
	...
	else
	{
		this.com_subState[3] = function ()
		{
			...
			else if (this.motion == 1110)
			{
				...
				if (this.com_rand[3] <= 6 && this.target.centerStop != 0)
				{
					this.CPU_ChainAttack(-60);
				}
...
function CPU_AtkDashHigh( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion == 1310 && this.keyTake >= 4)
		{
			return true;
		}
	};
	...
	this.com_subState[1] = function ()
	{
		...
		if (this.centerStop * this.centerStop <= 1)
		{
			...
			case 5:
				...
				{
					this.CPU_Slide(-35, this.rand() % 10 <= 5 ? 0 : -this.direction, -10);
					return true;
				}
			...
			case 14:
				...
				{
					this.CPU_Slide(-35, this.direction, -10);
					return true;
				}
		...
		else
		{
			...
			case 5:
				...
				if (this.com_rand[1] <= 9)
				{
					this.CPU_Slide(-35, this.rand() % 10 <= 5 ? 0 : -this.direction, this.y < this.centerY ? 1,00000000.0 : -1,00000000.0);
					return true;
				}
...
function CPU_Shot( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion >= 2000 && this.motion <= 2009 && this.keyTake >= 1)
		{
			if (this.com_rand[3] <= 8)
			{
...
function CPU_ShotFront( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if ((this.motion >= 2010 && this.motion <= 2019) && this.keyTake >= 1)
		{
...
function CPU_ShotCharge( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion == 2020 && this.keyTake >= 1)
		{
			if (this.com_rand[3] <= 9)
			{
				this.CPU_ChainMove(-60);
...
function CPU_ChainSkill( wait_ )
{
	...
	this.com_subState[1] = function ()
	{
		...
		if (this.com_rand[1] <= 3 && this.com_enemyPos >= 10)
		{
			this.CPU_SkillB(-60);
			return true;
		}
...
function CPU_SkillA( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion >= 3050 && this.motion <= 3059 && this.keyTake >= 1)
		{
			if (this.com_rand[3] <= 9)
			{
...
function CPU_SkillB( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion >= 3010 && this.motion <= 3019 && this.keyTake >= 1)
		{
			if (this.com_rand[3] <= 9)
			{
				this.CPU_ChainMove(-90);
...
function CPU_SkillD( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion >= 3040 && this.motion <= 3049 && this.keyTake >= 1)
		{
			if (this.com_rand[3] <= 9)
			{
				this.CPU_ChainMove(-90);
...
function CPU_SkillO( wait_ )
{
	...
	this.com_subState[3] = function ()
	{
		...
		if (this.motion == 2500 && this.keyTake == 3)
		{
			if (this.com_rand[3] <= 9)
			{
...
function CPU_ChainSpell( wait_ )
{
	...
	this.com_subState[1] = function ()
	{
		...
		{
		case 0:
			if (this.target.IsDamage() && this.target.recover >= 60 && this.abs(this.targetDist) <= 150 && this.target.y < this.y)
			{
				this.CPU_SpellA(-60);
				return true;
			}
		...
		case 2:
			...
			if (this.rand() % 100 <= 15 && this.CPU_CheckEnemyPos([
				2,
				5,
				8,
				16
...
function CPU_CheckSpell()
{
	...
	{
	case 0:
		if (this.abs(this.targetDist) <= 150 && this.target.y < this.y - 100 && this.rand() % 100 <= 3)
		{
			this.CPU_SpellA(-60);
			return true;
		}
	...
	case 2:
		if (this.rand() % 100 <= 1 && this.CPU_CheckEnemyPos([
			2,
			5,
			8,
			16
