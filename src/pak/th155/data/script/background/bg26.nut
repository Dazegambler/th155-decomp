function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.eye_z = -1100.00000000;
		this.fov = this.atan(w / -this.eye_z) * 1.20000005;
		this.z_far = 100000;
...
this.bloom_filter.InitBloom(this.src_target, 128, 1, 10.00000000, 2.00000000, 0.10000000, 0.94999999);
