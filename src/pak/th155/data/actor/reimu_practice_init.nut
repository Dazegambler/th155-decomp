...
this.manbow.CompileFile("data/actor/com_stack_action.nut", this.player_class);
this.manbow.CompileFile("data/actor/reimu_com_function.nut", this.player_class);
this.manbow.CompileFile("data/actor/script/practice_member.nut", this.player_class);
this.manbow.CompileFile("data/actor/script/practice_function.nut", this.player_class);
this.manbow.CompileFile("data/actor/script/practice_update.nut", this.player_class);
this.player_class.Com_Init <- function ()
{
};
