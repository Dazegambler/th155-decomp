	...
	this.func = [
		...
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				this.AddSpeed_XY(this.va.x * this.direction <= 12,50000000.0 ? 0,50000000.0 * this.direction : 0,05000000.0, -0,25000000.0);
	...
	this.stateLabel = function ()
	{
		...
		for( local i = 0; i < 6; i++ )
		{
			if (this.flag1[i])
			{
				...
				this.flag1[i].y = this.y + this.flag2.y * this.flag3 * 0,33000001.0;
		...
		this.flag2.RotateByDegree(6,00000000.0);
