...
function BeginBattleB( t )
{
	...
	this.func = function ()
	{
		...
		this.centerStop = -2;
		this.SetSpeed_XY((this.flag1.x - this.x) * 0,10000000.0, -6,50000000.0);
		this.stateLabel = function ()
		{
			this.AddSpeed_XY(0,00000000.0, 0,25000000.0);
			this.SetSpeed_XY((this.flag1.x - this.x) * 0,05000000.0, this.va.y);
	...
	this.stateLabel = function ()
	{
		...
		if (this.y >= this.centerY)
		{
			...
			this.SetSpeed_XY(this.va.x, -10,00000000.0);
		}
...
function BeginBattle_Udonge( t )
{
	...
	this.keyAction = [
		...
		function ()
		{
			this.SetSpeed_XY(0,00000000.0 * this.direction, -4,50000000.0);
			this.stateLabel = function ()
			{
				this.AddSpeed_XY(0,00000000.0, 0,50000000.0);
...
function WinB( t )
{
	...
	this.keyAction = [
		...
		{
			this.PlaySE(4071);
			this.demoObject[0] = this.SetFreeObject(640, 360, 1,00000000.0, this.WinB_Back, {}).weakref();
			this.count = 0;
...
function Atk_HighUnder_Init( t )
{
	...
	this.SetSpeed_XY(9,00000000.0 * this.direction, -12,50000000.0);
	this.centerStop = -2;
	this.Warp(this.x, this.centerY);
	this.keyAction = [
		function ()
	...
	this.stateLabel = function ()
	{
		...
		this.AddSpeed_XY(0,00000000.0, 1,10000002.0);
...
function Atk_HighUnder_Air_Init( t )
{
	...
	if (this.y < this.centerY)
	{
		...
		this.keyAction = [
			...
			function ()
			{
				...
				this.HitTargetReset();
				this.centerStop = -3;
				this.SetSpeed_XY(7,50000000.0 * this.direction, -12,00000000.0);
				this.stateLabel = function ()
				{
	...
	else
	{
		...
		this.SetSpeed_XY(null, -4,00000000.0);
		this.keyAction = [
			function ()
			{
				this.PlaySE(4010);
			...
			function ()
			{
				...
				this.stateLabel = function ()
				{
					if (this.y < this.centerY)
					{
						this.CenterUpdate(1,50000000.0, null);
					}
			...
			function ()
			{
				...
				this.HitTargetReset();
				this.centerStop = -3;
				this.SetSpeed_XY(10,00000000.0 * this.direction, -22,50000000.0);
				this.stateLabel = function ()
				{
					if (this.y < this.centerY)
					{
		...
		this.stateLabel = function ()
		{
			...
			this.AddSpeed_XY(null, 1,25000000.0);
			...
			if (this.ground)
			{
				...
				this.stateLabel = function ()
				{
					this.AddSpeed_XY(null, 0,33000001.0);
					this.VX_Brake(1,50000000.0);
				};
			}
		};
	...
	if (this.centerStop * this.centerStop >= 2 && this.y > this.centerY)
	{
		this.keyAction = [
			function ()
			{
				...
				this.stateLabel = function ()
				{
					this.VX_Brake(0,25000000.0, 4,00000000.0 * this.direction);
					this.AddSpeed_XY(0,00000000.0, this.y < this.centerY ? 0,75000000.0 : 0,15000001.0);
	...
	else
	{
		this.keyAction = [
			function ()
			{
				this.centerStop = -2;
				this.PlaySE(4012);
				this.SetSpeed_XY(12,00000000.0 * this.direction, -9,50000000.0);
				this.SetFreeObject(this.x - 30 * this.direction, this.y + 50, this.direction, this.Hammock, {});
				this.stateLabel = function ()
				{
					this.VX_Brake(0,50000000.0, 4,00000000.0 * this.direction);
					this.AddSpeed_XY(0,00000000.0, this.va.y < 0,00000000.0 ? 0,75000000.0 : 0,50000000.0);
...
function Atk_RushC_Front_Init( t )
{
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				this.VX_Brake(this.va.x * this.direction > 2,00000000.0 ? 0,75000000.0 : 0,20000000.0, 0,00000000.0);
			};
		},
		function ()
		{
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				this.AddSpeed_XY(1,50000000.0 * this.direction, 0,00000000.0);

				if (this.va.x > 15,00000000.0 * this.direction)
				{
					this.stateLabel = function ()
					{
						this.HitCycleUpdate(8);
						this.VX_Brake(0,50000000.0, 12,50000000.0 * this.direction);
					};
				}
			};
		},
...
function Shot_Normal_Air_Init( t )
{
	...
	this.SetSpeed_XY(this.va.x * 0,25000000.0, this.va.y * 0,25000000.0);
	this.AjustCenterStop();
	this.flag2 = this.y <= this.centerY ? -5,00000000.0 : 5,00000000.0;
	this.keyAction = [
		function ()
		{
			if (this.flag2 < 0)
			...
			this.SetSpeed_XY(-7,50000000.0 * this.direction, this.flag2);
			this.hitResult = 1;
			this.team.AddMP(-200, 90);
			this.PlaySE(4022);
			local t = {};
			...
			this.stateLabel = function ()
			{
				...
				{
					this.VX_Brake(0,10000000.0, -3,00000000.0 * this.direction);
				}
			};
		},
		function ()
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				{
					this.VX_Brake(0,33000001.0, -2,00000000.0 * this.direction);
				}
			};
		},
		function ()
...
function Shot_Burrage_Init( t )
{
	...
	this.flag2.vec.x = 1,00000000.0;
	this.flag2.range <- 5,00000000.0;
	...
	this.subState = function ()
	{
		if (this.count > 10 && this.team.mp > 0 && this.count % 3 == 1)
		{
			...
			this.flag2.vec.RotateByRadian(0,34906584.0);
			this.flag2.range += (150 - this.flag2.range) * 0,05000000.0;
		}
	};
	return true;
}
...
function Okult_Init( t )
{
	...
	this.keyAction = [
		function ()
		{
			...
			{
				this.back_park = this.SetFreeObjectStencil(640, 360, 1,00000000.0, this.Occult_Back, {}).weakref();
			}
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				{
					this.VX_Brake(0,75000000.0, 1,00000000.0 * (this.va.x > 0 ? 1,00000000.0 : -1,00000000.0));
				}
	...
	this.keyAction = [
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				if (this.va.y > 0,00000000.0 && (this.flag1 == null && this.y >= this.centerY || this.flag1 && this.y >= this.flag1.y))
				{
					this.lavelClearEvent = null;
...
function SP_Mine_Air_Init( t )
{
	...
	this.keyAction = [
		function ()
		{
			...
			this.PlaySE(4036);
			this.centerStop = -2;
			this.SetSpeed_XY(-10,00000000.0 * this.direction, -2,00000000.0);
			...
			this.stateLabel = function ()
			{
				...
				this.VX_Brake(0,34999999.0, -2,50000000.0 * this.direction);
			};
		},
		function ()
		{
...
function SP_Bed_Canon_Init( t )
{
	...
	this.flag3[0].x = -90,00000000.0;
	this.flag3[0].y = -140;
	this.flag3[1].x = -130,00000000.0;
	this.flag3[1].y = -60;
	this.flag3[2].x = -130,00000000.0;
	this.flag3[2].y = 20;
	this.flag3[3].x = -90,00000000.0;
	this.flag3[3].y = 100;
	this.lavelClearEvent = function ()
	{
...
function SP_Balloon( t )
{
	...
	if (this.centerStop * this.centerStop <= 1 || this.centerStop * this.centerStop >= 2 && this.y >= this.centerY)
	{
		this.keyAction = [
			function ()
			{
				...
				this.stateLabel = function ()
				{
					this.AddSpeed_XY(0,50000000.0 * this.direction, -0,20000000.0, 6,00000000.0 * this.direction, -6,00000000.0);

					if (this.y < this.centerY - 150 && this.va.y <= -4,50000000.0 || !this.flag1 && this.keyTake == 2 || this.y < this.centerY - 25 && this.count >= 45)
					{
						if (this.flag1)
						{
	...
	else
	{
		this.keyAction = [
			function ()
			{
				this.SetSpeed_XY(0,00000000.0, -1,50000000.0);
				this.team.AddMP(-200, 120);
				this.centerStop = -2;
				this.PlaySE(4042);
				this.count = 0;
				this.stateLabel = function ()
				{
					this.AddSpeed_XY(0,50000000.0 * this.direction, 0,25000000.0, 6,00000000.0 * this.direction, 6,00000000.0);
...
function Spell_B_Init( t )
{
	...
	this.keyAction = [
		...
		function ()
		{
			...
			this.hitResult = 1;
			local t_ = {};
			this.flag1 = this.SetShot(this.x + 250 * this.direction, this.y, this.direction, this.SpellShot_B, t_).weakref();
			this.lavelClearEvent = function ()
			{
				if (this.flag1)
				{
	...
	this.keyAction = [
		...
		function ()
		{
			...
			this.stateLabel = function ()
			{
				...
				{
					local t_ = {};
					t_.rot <- this.flag2 + (-15 + this.rand() % 31) * 0,01745329.0;
					this.flag3.x = 70,00000000.0;
...
function Spell_Climax_Init( t )
{
	...
	this.keyAction = [
		function ()
		{
			this.UseClimaxSpell(60, "–‚à‚¤–\x250cŠo‚\x2580‚\x255a‚­‚\x2500—Ç‚¢‚\x2560‚æ–");
			::battle.enableTimeUp = false;
			this.lavelClearEvent = function ()
			{
				::battle.enableTimeUp = true;
		...
		function ()
		{
			this.PlaySE(4056);
			this.count = 0;
			this.SetSpeed_XY(2,00000000.0 * this.direction, -0,69999999.0);
			this.centerStop = -2;
			...
			this.stateLabel = function ()
			{
				this.flag1 += 0,04000000.0;

				if (this.flag2)
				{
					this.flag2.SetCollisionScaling(this.flag1, this.flag1, 1,00000000.0);
...
function Climax_Hit( t )
{
	...
	this.stateLabel = function ()
	{
		...
		if (this.count == 30)
		{
			...
			this.flag4 = this.SetFreeObject(0, 0, 1,00000000.0, this.Climax_Seat, {}).weakref();
		}
...
function Climax_SceneA( t )
{
	...
	this.flag5 = {};
	this.flag5.back <- this.SetFreeObject(640, 360, 1,00000000.0, this.Climax_Back, {}).weakref();
	this.flag5.squeez <- this.SetFreeObject(640, 360, 1,00000000.0, this.Climax_Squeez, {}).weakref();
	this.flag5.enemy <- this.target.SetFreeObject(640, 360, -1,00000000.0, this.Climax_EnemyStun, {}).weakref();
	this.flag5.midBack <- null;
	this.flag5.base_back <- this.SetFreeObject(0, 0, 1,00000000.0, this.Climax_Back_Black, {}).weakref();
	...
	this.func = [
		function ()
		{
			...
			this.flag5.midBack = this.SetFreeObject(0, 0, 1,00000000.0, this.Climax_MidBack, {}).weakref();
			this.flag5.face = this.SetFreeObject(640, 360, 1,00000000.0, this.Climax_Cut, {}).weakref();
			this.stateLabel = function ()
			{
				if (this.count == 80)
				{
	...
	this.stateLabel = function ()
	{
		if (this.count == 30)
		{
			this.PlaySE(4060);
			local t_ = {};
			t_.scale <- 6,00000000.0;
			t_.rot <- -20 * 0,01745329.0;
			this.flag5.chain[2] = this.SetFreeObjectDynamic(640 - 440, 360 + 100, 1,00000000.0, this.Climax_ChainPre, t_).weakref();
		}
		...
		if (this.count == 60)
		{
			this.PlaySE(4060);
			local t_ = {};
			t_.scale <- 4,00000000.0;
			t_.rot <- 190 * 0,01745329.0;
			this.flag5.chain[3] = this.SetFreeObjectDynamic(640 + 420, 360 - 200, 1,00000000.0, this.Climax_ChainPre, t_).weakref();
		}

		if (this.count == 120)
		{
			this.PlaySE(4080);
			this.flag5.chain[0] = this.SetFreeObjectDynamic(600, 360, 1,00000000.0, this.Climax_Chain, {}).weakref();
			this.flag5.chain[1] = this.SetFreeObjectDynamic(680, 360, -1,00000000.0, this.Climax_Chain, {}).weakref();
		}
