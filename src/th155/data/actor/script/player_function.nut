function Reset_PlayerCommon( round_ = false )
{
	...
	this.masterRed = 1,00000000.0;
	this.masterGreen = 1,00000000.0;
	this.masterBlue = 1,00000000.0;
	...
	this.defRate = 1,00000000.0;
	this.baseAtkRate = 1,00000000.0;
	this.baseDefRate = 1,00000000.0;
	this.shield_rate = 1;
