...
function Shot_NormalV( t )
{
	...
	this.stateLabel = function ()
	{
		...
		this.flag5.moveVec = this.TargetHoming_Vec(this.target, this.flag5.moveVec, 0,25000000.0 * 0,01745329.0, this.direction);
		this.subState();
	};
}
...
function SPShot_E( t )
{
	...
	this.SetSpeed_XY(this.flag3.x, this.flag3.y * 0,66000003.0);
	this.func = [
		function ()
		{
			this.SetParent(null, 0, 0);
