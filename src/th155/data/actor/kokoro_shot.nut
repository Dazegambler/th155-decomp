...
function NormalShot( t )
{
	...
	this.stateLabel = function ()
	{
		this.TargetHoming(this.target, 2,00000000.0 * 0,01745329.0, this.direction);
		this.count++;
...
function Shot_Charge( t )
{
	...
	this.func = [
		...
		function ()
		{
			...
			this.cancelCount = 3;
			this.SetSpeed_Vec(10,00000000.0, this.GetTargetAngle(this.target, this.direction), this.direction);
			this.stateLabel = function ()
			{
