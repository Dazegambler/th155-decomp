...
function Boss_Shot_MS2( t )
{
	...
	this.SetSpeed_XY(6,00000000.0 - this.rand() % 13, -10,00000000.0 - this.rand() % 6);
}

function Boss_Shot_MS2_High( t )
{
	this.Boss_Shot_MS2_Common(t);
	this.SetSpeed_XY(6,00000000.0 - this.rand() % 13, -16,00000000.0 - this.rand() % 6);
}
...
function Boss_Shot_MS2_Common( t )
{
	...
	this.stateLabel = function ()
	{
		...
		this.AddSpeed_XY(0,00000000.0, 0,12500000.0, null, 5,00000000.0);
	};
}
