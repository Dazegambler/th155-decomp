...
this.animation_set.Load(0, "data/background/bg15/bg15.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 128, 1, 10,00000000.0, 1,00000000.0, 0,05000000.0, 0,94999999.0);
