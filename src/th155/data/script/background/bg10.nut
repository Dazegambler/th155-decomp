...
this.animation_set.Load(0, "data/background/bg11/bg11.msh", null);
...
this.animation_set.Load(10, "data/background/bg11/bg11_a.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 128, 1, 50,00000000.0, 4,00000000.0, 0,20000000.0, 0,69999999.0);
