function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.eye_z = -2500,00000000.0;
		this.fov = this.atan(w / -this.eye_z) * 2,50000000.0;
		this.z_far = 300000;
...
this.animation_set.Load(0, "data/background/bg12/bg12.msh", null);
...
this.animation_set.Load(10, "data/background/bg12/bg12_a.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 256, 1, 50,00000000.0, 2,00000000.0, 0,50000000.0, 0,69999999.0);
