function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.eye_z = -2000,00000000.0;
		this.fov = this.atan(w / -this.eye_z) * 1,10000002.0;
		this.z_far = 300000;
...
this.animation_set.Load(0, "data/background/bg45/bg02.msh", "data/background/bg45/bg02.tak");
...
this.animation_set.Load(10, "data/background/bg45/bg02_a.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 128, 2, 50,00000000.0, 4,00000000.0, 0,10000000.0, 0,80000001.0);
