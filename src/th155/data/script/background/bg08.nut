...
this.animation_set.Load(0, "data/background/bg08/bg08.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 64, 1, 50,00000000.0, 1,00000000.0, 0,10000000.0, 0,69999999.0);
