...
this.animation_set.Load(0, "data/background/bg24/bg24.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 256, 1, 50,00000000.0, 2,00000000.0, 0,30000001.0, 0,69999999.0);
