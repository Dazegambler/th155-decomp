...
this.animation_set.Load(0, "data/background/bg17/bg01.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 128, 1, 50,00000000.0, 5,00000000.0, 0,10000000.0, 0,85000002.0);
