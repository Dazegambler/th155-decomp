function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.eye_z = -1500,00000000.0;
		this.fov = this.atan(w / -this.eye_z) * 1,50000000.0;
		this.z_far = 300000;
...
this.animation_set.Load(0, "data/background/bg21/bg21.msh", null);
...
this.animation_set.Load(10, "data/background/bg21/bg21_a.msh", null);
...
this.animation_set.Load(10, "data/background/bg21/light.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 256, 1, 100,00000000.0, 7,00000000.0, 0,30000001.0, 0,60000002.0);
