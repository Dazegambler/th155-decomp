function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.at_y = ((camera.camera2d.top + camera.camera2d.bottom) / 2 - (560 + 100)) * 1 + 80;
		this.eye_y = this.at_y;
		this.at_y += -100000;
		local w = camera.camera2d.right - camera.camera2d.left;
		this.eye_z = -1300,00000000.0;
...
this.animation_set.Load(0, "data/background/bg31/bg01.msh", null);
