...
this.animation_set.Load(0, "data/background/bg25/bg25.msh", null);
...
this.animation_set.Load(10, "data/background/bg25/bg25_a.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 256, 2, 40,00000000.0, 3,00000000.0, 0,20000000.0, 0,69999999.0);
