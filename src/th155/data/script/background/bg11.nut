function SetCamera()
{
	::camera.func_update_3d = function ( camera )
	{
		...
		this.fov = this.atan(w / -this.eye_z) * 1,16999996.0;
		this.z_far = 300000;
...
this.animation_set.Load(0, "data/background/bg10/bg10.msh", null);
...
this.bloom_filter.InitBloom(this.src_target, 128, 1, 50,00000000.0, 4,00000000.0, 0,10000000.0, 0,85000002.0);
